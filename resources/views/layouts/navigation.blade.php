<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('gallery') }}" class="flex items-center gap-2">
                        ...
                        <span class="text-lg font-semibold text-gray-900 hidden sm:inline">
                            {{ $stableBranding->name ?? config('app.name', 'Stables') }}
                        </span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('stables')" :active="request()->routeIs('stables')">
                        {{ __('Stables') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('stables')" :active="request()->routeIs('stables')">
                {{ __('Stables') }}

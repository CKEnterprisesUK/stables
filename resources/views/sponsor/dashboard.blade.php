        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @else
                ...
                <div class="flex justify-end mb-6 gap-3">
                    <a href="{{ route('sponsor.finance') }}" class="inline-flex items-center gap-2 px-4 py-2 text-indigo-700 bg-indigo-50 text-sm font-medium rounded-md hover:bg-indigo-100">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                        </svg>
                        Payment History
                    </a>
                    <a href="{{ route('sponsor.sponsorship.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700">

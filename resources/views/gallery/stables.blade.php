                            ...
                            <div class="flex items-start justify-between">
                                ...
                                @else
                                    <div class="flex items-center gap-2">
                                        ...
                                        <a href="{{ route('gift.create', $horse) }}" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-brand-700 border border-brand-600 rounded-lg hover:bg-brand-50 transition-colors" title="Gift a sponsorship">

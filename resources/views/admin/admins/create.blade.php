...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-stable-900">Add Admin User</h1>
        <p class="mt-1 text-sm text-stable-500">Create a new admin account with the appropriate role.</p>
    </div>
